...
set rc [catch {
  ...
  set_property ip_repo_paths d:/SingleT_CPU/SingleT_CPU.cache/ip [current_project]
  set_property ip_output_repo d:/SingleT_CPU/SingleT_CPU.cache/ip [current_project]
  add_files -quiet D:/SingleT_CPU/SingleT_CPU.runs/synth_1/Main.dcp
